...
dev.off()
## Figure S5 - Posterior Events  ####
pdf(file = here('figures_and_results','figureS5.pdf'),width = 7,height = 10)
...
pdf(file = here('figures_and_results','figureS6.pdf'),width = 5,height = 5)
...
## Figure S7 - Trace Plot ####
pdf(file = here('figures_and_results','figureS7.pdf'),width = 7.5,height = 7.5)
...
dev.off()
## Figure S8 - Fitted Model ####
pdf(file = here('figures_and_results','figureS8.pdf'),width = 7,height = 3)
par(mfrow=c(1,3))
...
## Figure S9 - Posterior Marginal Distributions ####
options(scipen=9999)
pdf(file = here('figures_and_results','figureS9.pdf'),width = 7.5,height = 7.5)
...
## Figure S10 - Posterior Predictive Checks ####
pdf(file = here('figures_and_results','figureS10.pdf'),width = 5,height = 6)
