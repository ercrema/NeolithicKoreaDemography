...
postHPDplot(params.coastal$r1*100,xlab='Annual Growth Rate (%)',ylab='Probability',main=TeX('$r_1\\,Coastal$'),xlim=c(0,0.27))
postHPDplot(params.coastal$r2*100,xlab='Annual Growth Rate (%)',ylab='Probability',main=TeX('$r_2\\,Coastal$'),xlim=c(-0.22,0))
postHPDplot(params.coastal$mu,xlab='cal BP',ylab='Probability',main=TeX('$c\\,Coastal$'),xlim=c(6000,4500))
postHPDplot(params.inland$r1*100,xlab='Annual Growth Rate (%)',ylab='Probability',main=TeX('$r_1\\,Inland$'),xlim=c(0,0.27))
postHPDplot(params.inland$r2*100,xlab='Annual Growth Rate (%)',ylab='Probability',main=TeX('$r_2\\,Inland$'),xlim=c(-0.22,0))
postHPDplot(params.inland$mu,xlab='cal BP',ylab='Probability',main=TeX('$c\\,Inland$'),xlim=c(6000,4500))
postHPDplot(params.all$r1*100,xlab='Annual Growth Rate (%)',ylab='Probability',main=TeX('$r_1\\,All$'),xlim=c(0,0.27))
postHPDplot(params.all$r2*100,xlab='Annual Growth Rate (%)',ylab='Probability',main=TeX('$r_2\\,All$'),xlim=c(-0.22,0))
postHPDplot(params.all$mu,xlab='cal BP',ylab='Probability',main=TeX('$c\\,All$'),xlim=c(6000,4500))
dev.off()
