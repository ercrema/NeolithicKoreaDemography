...
bw=100 # tempoeral kernel bandwidth
...
# Composite Kernel Density Estimate with Bootstrapping ####
...
save(coastal.inland.permtest,millet.permtest,ckde.coastal,ckde.inland,exp.general.test,exp.coastal.test,exp.inland.test,logistic.general.test,logistic.coastal.test,logistic.inland.test,file='../R_image_files/spd_test_results.RData')
